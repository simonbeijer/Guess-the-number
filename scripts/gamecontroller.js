class Gamecontroller {
    ...
    opponentsAi = document.querySelector('.select-opponents-ai');
    opponentsPlayer = document.querySelector('.select-opponents-player');
    ...
    openGameSettings(newGameBtn) {
        ...
        setTimeout(() => {
            ...
            this.opponentsAi.classList.add('fadeIn');
            this.opponentsPlayer.classList.add('fadeIn');
    ...
    selectOpponent(){
        this.opponent1.addEventListener('click', () => {
            if (this.opponent1.classList.contains('not-selected1')) {
                ...
                this.opponent2Img.setAttribute('src', '/img/op3.png');
                this.opponent2.classList.add('not-selected3');
        ...
        this.opponent2.addEventListener('click', () => {
            if (this.opponent2.classList.contains('not-selected3')) {
                this.opponent2Img.setAttribute('src', '/img/op3selected.png');
                this.opponent2.classList.remove('not-selected3');
