    ...
    selectOpponent(){
        ...
        this.opponent3.addEventListener('click', () => {
            if (this.opponent3.classList.contains('not-selected3')) {
                this.opponent3.style.border = '5px solid rgb(99,210,151)';
